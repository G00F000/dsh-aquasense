...
const AQUACULTURE_KEYWORDS: RegExp[] = [
  // 鱼类品种与通称
 ...
 */
export function isCommandBlocked(content: string): boolean {
 ...
 */
export function isAquacultureRelated(content: string, hasImage: boolean): boolean {
 ...
 */
export function domainFilter(content: string, hasImage: boolean): DomainFilterResult {
