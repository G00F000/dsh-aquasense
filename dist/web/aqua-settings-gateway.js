 ...
 * 正常情形,静默跳过。
 */
export function registerAquaSettingsNamespace(ctx) {
 ...
 */
export function createAquaSettingsApi(deps) {
 ...
 * (与 remind-gateway 一致)。
 */
export async function handleAquaSettingsHttp(dispatch, req, res) {
    try {
 ...
 */
export function installAquaSettingsWeb(ctx) {
