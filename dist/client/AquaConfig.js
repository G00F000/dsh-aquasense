...
function AquaConfigPage({ box, t, api, onClose }) {
    ...
    return (_jsxs("div", { className: "aqs-page", role: "dialog", "aria-modal": "false", "aria-label": t('page.title'), style: { top: box.top, left: box.left, width: box.width, height: box.height }, children: [_jsxs("div", { className: "aqs-top", children: [_jsxs("div", { className: "aqs-tabs", role: "tablist", "aria-label": t('page.title'), children: [_jsx("button", { type: "button", role: "tab", className: 'aqs-tab' + (tab === 'remind' ? ' on' : ''), "aria-selected": tab === 'remind', onClick: () => {
                                    setTab('remind');
