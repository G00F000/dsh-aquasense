...
import { AquaSettingsCard } from './AquaSettingsCard.js';
import { en as settingsEn, SETTINGS_NS, zh as settingsZh } from './settings-locales.js';
/** 所需服务:槽位注册 + 字典面 */
...
export function apply(ctx) {
    ...
    ctx.effect(() => ctx.locale.register(SETTINGS_NS, { zh: settingsZh, en: settingsEn }), 'aquasense-settings: dictionaries');
